 ...
 * - Palier 1 → "CE2-révision" : fractions emblématiques vues en cycle 2 rénové
 * - Paliers 2-3 → "CM1" : consolidation et extension des fractions simples
 *
...
export const WORLD1_CHALLENGES = [
    // ── Palier 1 : fractions emblématiques — CE2-révision ──
    {
        num: 1,
        den: 2,
        max: 2,
    ...
    // ── Palier 2 : fractions proches de 1 — CM1 ──
    {
        num: 3,
        den: 4,
        max: 2,
    ...
    // ── Palier 3 : dénominateurs plus grands — CM1 ──
    {
        num: 3,
        den: 8,
        max: 2,
