 ...
 *
 * Sprint C — représentations variées (BO n°16, 2026) :
 * En phase post-réponse (showCorrection), les paliers 2-3 (index ≥ 2) affichent
 * une représentation supplémentaire en rotation selon index % 2 :
 *   pair  → FractionDisc
 *   impair → FractionTriangle
 * La FractionBar reste toujours visible.
 * Principe Tricot : pas de surcharge pendant la tâche — uniquement post-réponse.
 *
...
function WorldFarm({ onComplete }) {
    ...
    // Représentation supplémentaire post-réponse, paliers 2-3 (index ≥ 2)
    const extraRep =
        ...
        >
            ...
            <main style={{ maxWidth: "42rem", margin: "0 auto" }}>
                ...
                >
                    ...
                    {/* Représentation supplémentaire post-réponse — paliers 2-3 (BO n°16) */}
                    {extraRep && (
                        <div
                            className="animate-float-up"
                            style={{
                        ...
                        >
                            ...
                            >
                                Même fraction, autre représentation :
                            </p>
                            {extraRep === "disc" ? (
                                <FractionDisc
                                    numerator={challenge.num}
